package com.example.toyou.common.apiPayload.code.status;

import com.example.toyou.common.apiPayload.code.BaseErrorCode;
import com.example.toyou.common.apiPayload.code.ErrorReasonDTO;
...
public enum ErrorStatus implements BaseErrorCode {
    ...
    EMOTION_ALREADY_CHOSEN(HttpStatus.CONFLICT, "USER402", "이미 오늘 감정을 선택한 상태입니다."),
    ALREADY_JOINED(HttpStatus.CONFLICT, "USER403", "이미 존재하는 유저입니다."),
    EXISTING_NICKNAME(HttpStatus.CONFLICT, "USER404", "이미 존재하는 닉네임입니다."),
    ...
    REFRESH_TOKEN_INVALID(HttpStatus.UNAUTHORIZED, "OAUTH402", "유효하지 않은 리프레시 토큰(애플)입니다."),
    ...
    FCM_TOKEN_ALREADY_EXISTING(HttpStatus.CONFLICT, "FCM403", "이미 존재하는 토큰 정보입니다.");
